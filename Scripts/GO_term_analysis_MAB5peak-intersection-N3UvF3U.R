...
MAB5.N <- N2[which(rownames(N2) %in% MAB5.all), ] #204
...
write.table(my.dataOrdered, 
            ...
            quote = FALSE,
            sep = "\t",
            file="Results/DEseq/Groups/GO/N3UvF3U-N3Uup-withMAB5peak.txt")
...
MAB5.F <- fem[which(rownames(fem) %in% MAB5.all), ] #209
...
write.table(my.dataOrdered, 
            ...
            quote = FALSE,
            sep = "\t",
            file="Results/DEseq/Groups/GO/N3UvF3U-F3Uup-withMAB5peak.txt")
